...
|Getting attachments or the entire selected item|An Outlook contextual add-in can access attachments and the entire selected item from the server-side. See the following:
